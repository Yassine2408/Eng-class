...
export const sessions: Session[] = [
  {
    ...
    phrases: [
      { id: genId(), phrase: 'What\'s your name?', translation: '询问名字', situation: 'First meeting' },
      { id: genId(), phrase: 'Where are you from?', translation: '询问来自哪里', situation: 'First meeting' },
      { id: genId(), phrase: 'What do you do?', translation: '询问职业', situation: 'Getting to know someone' },
      { id: genId(), phrase: 'How are you?', translation: '问候', situation: 'Greeting' },
      { id: genId(), phrase: 'Nice to meet you.', translation: '很高兴认识你', situation: 'First meeting' },
    ],
    grammar: {
  ...
  },
  {
    ...
    phrases: [
      { id: genId(), phrase: 'Excuse me, can you help me?', translation: '打扰一下，能帮我吗？', situation: 'Asking for help' },
      { id: genId(), phrase: 'Where is the...?', translation: '...在哪里？', situation: 'Finding places' },
      { id: genId(), phrase: 'How much is...?', translation: '...多少钱？', situation: 'Shopping' },
      { id: genId(), phrase: 'Can you repeat that?', translation: '能再说一遍吗？', situation: 'Not understanding' },
      { id: genId(), phrase: 'I don\'t understand.', translation: '我不明白', situation: 'Confusion' },
      { id: genId(), phrase: 'Could you speak slowly?', translation: '能说慢一点吗？', situation: 'Communication difficulty' },
    ],
    grammar: {
  ...
  },
  {
    ...
    phrases: [
      { id: genId(), phrase: 'Can I see your passport?', translation: '请出示您的护照', situation: 'Check-in' },
      { id: genId(), phrase: 'How many bags are you checking?', translation: '您要托运几个包？', situation: 'Check-in' },
      { id: genId(), phrase: 'Window or aisle seat?', translation: '靠窗还是靠过道的座位？', situation: 'Seat selection' },
      { id: genId(), phrase: 'Your gate is...', translation: '您的登机口是...', situation: 'Information' },
      { id: genId(), phrase: 'Boarding at...', translation: '登机时间是...', situation: 'Information' },
    ],
    grammar: {
  ...
  },
  {
    ...
    phrases: [
      { id: genId(), phrase: 'I\'d like to book a room.', translation: '我想预订一个房间', situation: 'Booking' },
      { id: genId(), phrase: 'I have a reservation.', translation: '我有预订', situation: 'Check-in' },
      { id: genId(), phrase: 'Is breakfast included?', translation: '包含早餐吗？', situation: 'Amenities' },
      { id: genId(), phrase: 'What\'s the WiFi password?', translation: 'WiFi密码是什么？', situation: 'Amenities' },
      { id: genId(), phrase: 'There is a problem with...', translation: '...有问题', situation: 'Problems' },
    ],
    grammar: {
  ...
  },
  {
    ...
    phrases: [
      { id: genId(), phrase: 'I\'d like to order, please.', translation: '我想点餐', situation: 'Ordering' },
      { id: genId(), phrase: 'Could I have the menu?', translation: '能给我菜单吗？', situation: 'Starting' },
      { id: genId(), phrase: 'What do you recommend?', translation: '你推荐什么？', situation: 'Choosing' },
      { id: genId(), phrase: 'I\'ll have the...', translation: '我要...', situation: 'Ordering' },
      { id: genId(), phrase: 'Could I have the bill, please?', translation: '请给我账单', situation: 'Paying' },
      { id: genId(), phrase: 'Excuse me, this is cold.', translation: '打扰一下，这个凉了', situation: 'Complaint' },
    ],
    grammar: {
  ...
  },
  {
    ...
    phrases: [
      { id: genId(), phrase: 'How do I get to...?', translation: '我怎么去...？', situation: 'Asking directions' },
      { id: genId(), phrase: 'Is it within walking distance?', translation: '步行能到吗？', situation: 'Distance' },
      { id: genId(), phrase: 'Go straight, then turn left.', translation: '直走，然后左转', situation: 'Giving directions' },
      { id: genId(), phrase: 'How much is a ticket to...?', translation: '去...的票多少钱？', situation: 'Transport' },
      { id: genId(), phrase: 'Could you call a taxi?', translation: '能帮我叫辆出租车吗？', situation: 'Transport' },
    ],
    grammar: {
  ...
  },
  {
    ...
    phrases: [
      { id: genId(), phrase: 'I went to... last year.', translation: '去年我去了...', situation: 'Travel stories' },
      { id: genId(), phrase: 'It was amazing/terrible.', translation: '很棒/很糟糕', situation: 'Describing experiences' },
      { id: genId(), phrase: 'I stayed there for...', translation: '我在那里待了...', situation: 'Duration' },
      { id: genId(), phrase: 'Have you ever been to...?', translation: '你去过...吗？', situation: 'Asking about experiences' },
    ],
    grammar: {
      title: 'Past Simple',
  ...
  },
  {
    ...
    phrases: [
      { id: genId(), phrase: 'I don\'t feel well.', translation: '我感觉不舒服', situation: 'Feeling sick' },
      { id: genId(), phrase: 'I lost my passport.', translation: '我丢了护照', situation: 'Lost item' },
      { id: genId(), phrase: 'I need help.', translation: '我需要帮助', situation: 'Emergency' },
      { id: genId(), phrase: 'Where is the nearest hospital?', translation: '最近的医院在哪里？', situation: 'Medical' },
      { id: genId(), phrase: 'Do you have something for...?', translation: '你有治...的药吗？', situation: 'Pharmacy' },
      { id: genId(), phrase: 'I have a headache.', translation: '我头疼', situation: 'Symptoms' },
    ],
    grammar: {
      title: 'I have... / I need...',
...
export const phrasebook: PhraseItem[] = [
  // Airport
  { id: genId(), phrase: 'Where is the check-in counter?', translation: '值机柜台在哪里？', category: 'Airport', situation: 'Finding your way' },
  { id: genId(), phrase: 'What time does boarding start?', translation: '什么时候开始登机？', category: 'Airport', situation: 'Timing' },
  { id: genId(), phrase: 'Is this flight on time?', translation: '这个航班准时吗？', category: 'Airport', situation: 'Status' },
  { id: genId(), phrase: 'Can I have a window seat?', translation: '能给我靠窗的座位吗？', category: 'Airport', situation: 'Seating' },
  { id: genId(), phrase: 'Where is gate A12?', translation: 'A12登机口在哪里？', category: 'Airport', situation: 'Finding your way' },
  { id: genId(), phrase: 'My flight is delayed.', translation: '我的航班延误了。', category: 'Airport', situation: 'Problems' },
  { id: genId(), phrase: 'I missed my connecting flight.', translation: '我错过了转机航班。', category: 'Airport', situation: 'Problems' },
  
  // Hotel
  { id: genId(), phrase: 'I have a reservation under [name].', translation: '我用[名字]预订了房间。', category: 'Hotel', situation: 'Check-in' },
  { id: genId(), phrase: 'What time is breakfast?', translation: '早餐几点？', category: 'Hotel', situation: 'Amenities' },
  { id: genId(), phrase: 'Is there a gym?', translation: '有健身房吗？', category: 'Hotel', situation: 'Amenities' },
  { id: genId(), phrase: 'Could I have extra towels?', translation: '能多给我几条毛巾吗？', category: 'Hotel', situation: 'Requests' },
  { id: genId(), phrase: 'The AC doesn\'t work.', translation: '空调坏了。', category: 'Hotel', situation: 'Problems' },
  { id: genId(), phrase: 'What time is check-out?', translation: '退房时间是几点？', category: 'Hotel', situation: 'Check-out' },
  { id: genId(), phrase: 'Can I store my luggage here?', translation: '我可以把行李寄存在这里吗？', category: 'Hotel', situation: 'Services' },
  
  // Restaurant
  { id: genId(), phrase: 'A table for two, please.', translation: '两个人用餐。', category: 'Restaurant', situation: 'Arriving' },
  { id: genId(), phrase: 'Could I see the menu?', translation: '能给我菜单吗？', category: 'Restaurant', situation: 'Ordering' },
  { id: genId(), phrase: 'I\'m allergic to nuts.', translation: '我对坚果过敏。', category: 'Restaurant', situation: 'Dietary' },
  { id: genId(), phrase: 'Is this dish vegetarian?', translation: '这道菜是素食吗？', category: 'Restaurant', situation: 'Dietary' },
  { id: genId(), phrase: 'Could I have a glass of water?', translation: '能给我一杯水吗？', category: 'Restaurant', situation: 'Drinks' },
  { id: genId(), phrase: 'This is not what I ordered.', translation: '这不是我点的。', category: 'Restaurant', situation: 'Problems' },
  { id: genId(), phrase: 'Could I have the bill, please?', translation: '请给我账单。', category: 'Restaurant', situation: 'Paying' },
  { id: genId(), phrase: 'Can I pay by card?', translation: '可以刷卡吗？', category: 'Restaurant', situation: 'Paying' },
  
  // Directions
  { id: genId(), phrase: 'How do I get to the station?', translation: '去车站怎么走？', category: 'Directions', situation: 'Asking' },
  { id: genId(), phrase: 'Is it within walking distance?', translation: '步行能到吗？', category: 'Directions', situation: 'Distance' },
  { id: genId(), phrase: 'Could you show me on the map?', translation: '能在地图上给我指一下吗？', category: 'Directions', situation: 'Clarification' },
  { id: genId(), phrase: 'Turn left at the traffic light.', translation: '在红绿灯处左转。', category: 'Directions', situation: 'Giving' },
  { id: genId(), phrase: 'It\'s on the right side.', translation: '在右手边。', category: 'Directions', situation: 'Giving' },
  { id: genId(), phrase: 'Go straight for two blocks.', translation: '直走两个街区。', category: 'Directions', situation: 'Giving' },
  
  // Emergencies
  { id: genId(), phrase: 'I need help!', translation: '我需要帮助！', category: 'Emergencies', situation: 'Urgent' },
  { id: genId(), phrase: 'Call an ambulance!', translation: '叫救护车！', category: 'Emergencies', situation: 'Medical' },
  { id: genId(), phrase: 'I need to see a doctor.', translation: '我需要看医生。', category: 'Emergencies', situation: 'Medical' },
  { id: genId(), phrase: 'Where is the nearest hospital?', translation: '最近的医院在哪里？', category: 'Emergencies', situation: 'Medical' },
  { id: genId(), phrase: 'I lost my passport.', translation: '我丢了护照。', category: 'Emergencies', situation: 'Lost items' },
  { id: genId(), phrase: 'Someone stole my wallet.', translation: '有人偷了我的钱包。', category: 'Emergencies', situation: 'Crime' },
  { id: genId(), phrase: 'I need to call the police.', translation: '我需要报警。', category: 'Emergencies', situation: 'Crime' },
  { id: genId(), phrase: 'I don\'t feel well.', translation: '我感觉不舒服。', category: 'Emergencies', situation: 'Medical' },
];
